...
const EditTeam = () => {
  ...
  const getData = async () => {
    const res = await axios(`https://my-hours.onrender.com/teamMember/${id}`);
    setForm(res.data);
  };

  const handlePatch = async () => {
    await axios.put(`https://my-hours.onrender.com/teamMember/${id}`, form);
    navigate('/teams');
  };
            ...
            <Accordion allowMultiple mt='30'>
              <AccordionItem>
                ...
                <AccordionPanel pb={4}>
                  ...
                  cost. This rate can be further specified on individual
                  projects.
                  <InputGroup mt='5'>
              ...
              <AccordionItem>
                ...
                <AccordionPanel pb={4}>
                  Enter default billable rate for the team form to calculate
                  Billable cost. This rate can be further specified on
                  individual projects.
                  <InputGroup mt='5'>
                    <InputLeftAddon h='8' children='INR' />
                    <Input
