...
const AddTeam = () => {
  ...
  const postData = async () => {
    await axios.post(
      'https://my-hours.onrender.com/teamMember/teamMemberpost',
      form
    );
    navigate('/teams');
  };
          ...
          <FormControl>
            ...
            <Accordion allowMultiple mt='30'>
              <AccordionItem>
                ...
                <AccordionPanel pb={4}>
                  Enter default hourly rate for the team member to calculate
                  Labor cost. This rate can be further specified on individual
                  projects.
                  <InputGroup mt='5'>
