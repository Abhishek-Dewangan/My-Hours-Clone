          ...
          <SimpleGrid mt={'3rem'} spacing={2} columns={{sm: 1, md: 3}}>
            ...
            <Box align='left'>
              <Highlight
                ...
                letterSpacing={0}
              >
                "I really love this time tracking software. It keeps track of
                all my hours and is really easy to use. I would definitely
                recommend this software. There is nothing that I don't like
                about this software."
              </Highlight>
              <Text
                fontStyle='italic'
